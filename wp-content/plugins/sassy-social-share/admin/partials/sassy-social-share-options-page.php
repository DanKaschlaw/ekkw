				...
				<div class="stuffbox">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-table editcomment menu_content_table">
						...
						<tr>
							...
							<br/>
							<span class="heateor_sss_help_content" style="display:block"><?php _e( 'Share counts are supported for Facebook, Twitter, Linkedin, GooglePlus, Delicious, Buffer, Reddit, Pinterest, Stumbleupon and Vkontakte', 'sassy-social-share' ) ?></span>
							</td>
						</tr>
